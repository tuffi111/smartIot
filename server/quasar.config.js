...
require('./resources/frontend/app/utils/dotEnv.js')
...
module.exports = configure(function (/* ctx */) {
    return {
        ...
        sourceFiles: {
            rootComponent: 'resources/frontend/src/App.vue',
            electronMain: "resources/electron/main",
            electronPreload: "resources/electron/preload",
            /*router: "",
            store: "",
        ...
        build: {
            ...
            vitePlugins: [
                // todo: intlify/vite-plugin-vue-i18n not compatible atm.
            ...
            extendViteConf(viteConf, {isServer, isClient}) {
                ...
                viteConf.resolve = mergeConfig(viteConf.resolve, {
                    alias: {
                        ...
                        //'@': fileURLToPath(new URL('./resources/frontend/src', process.env.VITE_API_URL)),
                        '@app': path.resolve('./resources/frontend/app'),
                        //'@app': fileURLToPath(new URL('./resources/frontend/app', process.env.VITE_API_URL)),
                        'ziggy': path.resolve('vendor/tightenco/ziggy/dist/index.es'),
                        //'ziggyVue': path.resolve('vendor/tightenco/ziggy/dist/vue.es'),
                    }
                })

                viteConf.watch = mergeConfig(viteConf.watch, {
                    ignored: ["**/vendor/**"],
                })
